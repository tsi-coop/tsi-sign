package org.tsicoop.sign.legal;
...
public class LegalCertificateRepository {
    ...
    public String insert(String documentId, String appId, int version, String partAJson, String partBJson,
            ...
            throws Exception {
        String sql = "INSERT INTO legal_certificates " +
    ...
    public Optional<CertificateRecord> findLatestForApp(String appId, String documentId) {
        String sql = "SELECT certificate_id, document_id, app_id, version, part_a::text AS part_a, " +
    ...
    public List<RegistryEntry> listAll() throws Exception {
        String sql = "SELECT lc.certificate_id, lc.document_id, d.title AS document_title, lc.app_id, " +
                "a.app_name, lc.version, lc.certificate_hash, lc.created_at::text AS created_at " +
